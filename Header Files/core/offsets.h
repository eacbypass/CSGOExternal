...
=======
	constexpr ::std::ptrdiff_t dwLocalPlayer = 0xDB558C; // updated 12/12/2021
	constexpr ::std::ptrdiff_t dwEntityList = 0x4DD0A84; // updated 12/12/2021
	constexpr ::std::ptrdiff_t dwForceAttack = 0x3200F94; // updated 12/12/2021
	constexpr ::std::ptrdiff_t dwForceJump = 0x527A97C; // updated 12/13/2021 
>>>>>>> b89f9acef2113ce0800d21e63d675e7f6b7ffaf2
...
=======
	constexpr ::std::ptrdiff_t m_iHealth = 0x100; // updated 12/12/2021
	constexpr ::std::ptrdiff_t m_iTeamNum = 0xF4; // updated 12/12/2021
	constexpr ::std::ptrdiff_t m_iCrosshairId = 0x11838; // updated 12/12/2021
	constexpr ::std::ptrdiff_t m_clrRender = 0x70; // updated 12/13/2021
	constexpr ::std::ptrdiff_t m_fFlags = 0x104; // updated 12/13/2021
	constexpr ::std::ptrdiff_t m_aimPunchAngle = 0x303C; // updated 12/13/2021
	constexpr ::std::ptrdiff_t m_iShotsFired = 0x303C; // updated 12/13/2021
>>>>>>> b89f9acef2113ce0800d21e63d675e7f6b7ffaf2
