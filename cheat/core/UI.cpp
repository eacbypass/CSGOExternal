...
const char* const KeyNames[] = { // Pasted from CSGOSimple https://github.com/spirthack/CSGOSimple/blob/master/CSGOSimple/UI.cpp
	"Unknown",
	"VK_LBUTTON",
	"VK_RBUTTON",
	"VK_CANCEL",
...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
	...
	const bool focus_requested_by_code = focus_requested && (window == window);
